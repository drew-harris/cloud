...
>(({ index, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "relative flex h-10 w-10 items-center justify-center border-y-2 border-r-2 border-black text-sm transition-all font-mono uppercase first:border-l-2 dark:border-gray-800",
        isActive &&
